...
describe("nipmod discovery manifest", () => {
  ...
  test("keeps docs and agent commands focused on API access", () => {
    expect(manifest.docs).toEqual({
      ...
      agentDemoFlow: "https://nipmod.com/agent-demo-flow.json",
      ...
      integrationKit: "https://nipmod.com/integration-kit.json",
      integrations: "https://nipmod.com/integrations",
      investors: "https://nipmod.com/investors",
      ...
      sourceQualityReport: "https://nipmod.com/source-quality.json",
    ...
    expect(manifest.agent.commands).toMatchObject({
      ...
      readDemoFlow: "GET https://nipmod.com/agent-demo-flow.json",
      readIntegrationKit: "GET https://nipmod.com/integration-kit.json",
      readLlms: "GET https://nipmod.com/llms.txt",
      readOpenApi: "GET https://nipmod.com/api/openapi with x-nipmod-api-key",
      readSourceQuality: "GET https://nipmod.com/source-quality.json",
