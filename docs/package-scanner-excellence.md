...
1. Search quality benchmark
   - Fixed offline benchmark cases cover npm, PyPI, Hugging Face models, MCP, partial source outages, dependency-confusion lookalikes, PyPI confusion aliases, typo-squat aliases, stale/deprecated package decoys, remote-code model decoys and crypto-drainer package decoys.
