...
async function checkLiveEndpoints() {
  const endpoints = [
    ["setup_page", "https://nipmod.com/setup", ["Install Nipmod once", "Codex", "Claude Code"]],
    [
      "cursor_page",
    ...
    ["platform_page", "https://nipmod.com/platforms", ["Platform connections", "Only usable paths are shown", "Visible paths"]],
    [
      "discovery_manifest",
