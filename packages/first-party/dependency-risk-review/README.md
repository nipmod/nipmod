...
- Produces a concise decision that can be used before `nipmod add`, `nipmod audit` or `nipmod ci`.
...
```bash
nipmod add pkg:did:key:z6Mkqm8Ub1wbA79siRozF1Q7j1DjixxFNAsHnSSfPaT2iA1C/dependency-risk-review@0.1.0 --online
```
