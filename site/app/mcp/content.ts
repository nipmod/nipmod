export const mcpContent = {
  ...
  remote: {
    ...
    text: "Agents can search the verified archive, resolve external packages from major sources, inspect trust and create install plans over HTTPS without a local install. Workspace writes stay local.",
    endpoint: "https://nipmod.com/api/mcp",
    listTools:
      '{"jsonrpc":"2.0","id":1,"method":"tools/list"}',
    search:
      '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"nipmod.search","arguments":{"query":"package"}}}',
    tools: [
      "nipmod.search",
      "nipmod.resolve",
      "nipmod.view",
  ...
  safety: [
    {
      label: "Read first",
      text: "Hosts can search the verified archive, resolve external packages, inspect trust and create install plans before any workspace write."
    },
    {
  ...
  examples: [
    ...
    },
    {
      label: "Plan install",
      command:
        '{"jsonrpc":"2.0","id":6,"method":"tools/call","params":{"name":"nipmod.install_plan","arguments":{"specifier":"<package-specifier>"}}}'
    },
    {
      label: "Install after approval",
      command:
        '{"jsonrpc":"2.0","id":7,"method":"tools/call","params":{"name":"nipmod.install","arguments":{"specifier":"<package-specifier>","confirmInstall":"write-lockfile"}}}'
    },
    {
      label: "Demo flow",
      command:
        '{"jsonrpc":"2.0","id":8,"method":"tools/call","params":{"name":"nipmod.demo","arguments":{"host":"Codex","package":"<package-specifier>"}}}'
    },
    {
      label: "Verify claim",
      command:
        '{"jsonrpc":"2.0","id":9,"method":"tools/call","params":{"name":"nipmod.claim_verify","arguments":{"repo":"gitlawb://did:key:z6Mk.../repo"}}}'
    },
    {
      label: "Audit",
      command:
        '{"jsonrpc":"2.0","id":10,"method":"tools/call","params":{"name":"nipmod.audit","arguments":{}}}'
    }
  ],
  hosts: [
    {
...
args = ["mcp", "serve"]`,
      ...
      prompt: "Use Nipmod to search packages, inspect trust, plan install, then install only after I approve the lockfile write."
    },
    {
      name: "Claude Code",
  ...
  nipmod:
    ...
    tools:
      ...
      prompt: "Use the nipmod MCP server. Search for the package, inspect trust and prepare an install plan before any package write."
    }
  ],
  demo: {
    headline: "Agent demo path",
    lead: "This is the proof path agents can run through MCP after a package is listed.",
    prompt:
