...
function hermesText() {
  return [
    ...
    "",
    "Then tell Hermes",
    "Use Nipmod MCP before installing agent packages.",
    "",
    "Note",
    "This is the prepared MCP path, not official Hermes partner support."
  ].join("\n");
}
...
async function main() {
  if (process.argv.includes("--help")) {
    process.stdout.write(
      [
        "Usage: node --experimental-strip-types tools/telegram-bot.ts",
        "",
        "Required env:",
        "  TELEGRAM_BOT_TOKEN",
        "",
