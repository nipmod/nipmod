...
tags: [packages, gitlawb, agents, provenance, x402, developer-tools]
version: 1
visibility: public
metadata:
  clawdbot:
...
- Call Nipmod x402 services from Bankr when paid package actions are enabled.
...
Use references/x402-services.md for paid package service plans.
...
- Do not publish, push, open issues, spend funds or call paid endpoints without clear user approval.
